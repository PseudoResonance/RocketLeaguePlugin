...
public class RequestQueue {
	...
	public CompletableFuture<JsonNode> post(String apiKey, String apiVersion, String endpoint, Query query, String body) {
		return request(apiKey, apiVersion, endpoint, query, body, true);
	}
	
	public CompletableFuture<JsonNode> get(String apiKey, String apiVersion, String endpoint, Query query) {
		return request(apiKey, apiVersion, endpoint, query, null, false);
	}
	
	private CompletableFuture<JsonNode> request(String apiKey, String apiVersion, String endpoint, Query query, String body, boolean post) {
